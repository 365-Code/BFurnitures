    ...
    <header id='hdr'
     ...
     <div className='relative h-[138px] sm:h-[158px] md:h-[78px] bg-[#E7E7E7]' />
      ...
      >
        ...
        <div className={`transition-all ${menu.mode == "visible" && " z-[1]  bg-white/30 backdrop-blur-sm"} w-[80vw] h-screen sm:${()=>handleMenu} p-4 overflow-hidden sm:overflow-visible absolute sm:p-0 top-0 left-0 sm:w-auto sm:h-full sm:left-0 sm:top-0 sm:relative`}>
          <button 
