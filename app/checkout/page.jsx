...
const Page = () => {
  ...
  <div id="checkout" className="flex justify-between gap-4">

    <div className="flex basis-[60%] flex-col justify-between gap-6">
  ...
  <div className="basis-[30%] rounded-lg bg-gradient-to-b from-[#273141] to-[#273d41] p-8 text-white space-y-4">

    <div>
        <h2 className='text-2xl font-semibold'>PaymentMethod Info</h2>
        <hr />
    </div>
