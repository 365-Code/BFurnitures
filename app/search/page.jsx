...
//   const res = await fetch(`http://localhost:3000/api/product/getproduct/?page=${page}`, {
//     cache: 'no-store'
//   })
...
const Page = () => {
  ...
  const loadProducts = async (page=1,search,category)=>{
      const res = await fetch(`http://localhost:3000/api/product/searchproduct/?page=${page}&search=${search}&category=${category}`, {
        cache: 'no-store'
    })
